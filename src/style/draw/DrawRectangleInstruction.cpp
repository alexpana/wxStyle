...
typedef DrawRectangleInstruction::Builder Builder;
	...
	Builder::Builder(const DimRect& rect, const wxBrush& brush, int penSize, const wxColor& penColor, const wxPenStyle penStyle, const int cornerRadius) :
	...
	DrawRectangleInstruction Builder::Build() {
		return DrawRectangleInstruction(m_rect, m_brush, m_penSize, m_penColor, m_penStyle, m_cornerRadius);
	}
